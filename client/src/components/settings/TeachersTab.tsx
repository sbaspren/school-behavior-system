    ...
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px', paddingBottom: '16px', borderBottom: '1px solid #f0f0f0' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <span className="material-symbols-outlined" style={{ color: '#14b8a6', fontSize: '22px' }}>school</span>
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          <button onClick={() => { setEditingTeacher(null); setModalOpen(true); }} style={{
            ...
            <span className="material-symbols-outlined" style={{ fontSize: '20px' }}>person_add</span> إضافة يدوي
          </button>
          <label style={{
            display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 16px',
            background: '#0d9488', color: '#fff', borderRadius: '8px', fontWeight: 700, cursor: 'pointer',
          }}>
            <span className="material-symbols-outlined" style={{ fontSize: '20px' }}>upload_file</span> استيراد Excel
      ...
      {filteredTeachers.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '64px 20px', color: '#9ca3af' }}>
          <span className="material-symbols-outlined" style={{ fontSize: '48px', display: 'block', color: '#9ca3af', marginBottom: '16px' }}>school</span>
                  ...
                  return (
                    <tr key={t.id}>
                      ...
                      <td style={{ textAlign: 'center' }}>
                        <button onClick={() => { setEditingTeacher(t); setModalOpen(true); }} style={{ padding: '6px', color: '#0d9488', background: 'none', border: 'none', cursor: 'pointer' }}><span className="material-symbols-outlined" style={{ fontSize: '20px' }}>edit</span></button>
                        <button onClick={() => setConfirmDelete(t)} style={{ padding: '6px', color: '#dc2626', background: 'none', border: 'none', cursor: 'pointer' }}><span className="material-symbols-outlined" style={{ fontSize: '20px' }}>delete</span></button>
                      </td>
                    </tr>
                  );
                })}
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
          <div style={{ background: '#fff', borderRadius: '24px', boxShadow: '0 25px 50px rgba(0,0,0,0.25)', maxWidth: '420px', width: '100%', padding: '32px', textAlign: 'center' }}>
            <div style={{
              ...
              <span className="material-symbols-outlined" style={{ fontSize: '28px', color: importProgress.done ? '#15803d' : '#0d9488' }}>{importProgress.done ? 'check_circle' : 'sync'}</span>
            </div>
                  ...
                  return (
                    <div key={stageId} style={{ paddingBottom: '12px', borderBottom: detectedStageIds.length > 1 ? '1px solid #e5e7eb' : 'none', marginBottom: '8px' }}>
                      {detectedStageIds.length > 1 && (
                        <div style={{ fontWeight: 700, fontSize: '14px', color: colors.text, marginBottom: '8px' }}><span className="material-symbols-outlined" style={{ fontSize: '16px', verticalAlign: 'middle', marginLeft: '4px' }}>apartment</span> {stageInfo.name}</div>
                      )}
