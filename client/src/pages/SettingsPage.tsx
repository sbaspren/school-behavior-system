...
const TABS: { id: Tab; label: string; icon: string }[] = [
  { id: 'school', label: 'بيانات المدرسة', icon: 'apartment' },
  { id: 'structure', label: 'هيكل الصفوف', icon: 'account_tree' },
  { id: 'admins', label: 'الهيئة الإدارية', icon: 'admin_panel_settings' },
  { id: 'teachers', label: 'المعلمين', icon: 'school' },
  { id: 'students', label: 'الطلاب', icon: 'groups' },
  { id: 'links', label: 'روابط النماذج', icon: 'link' },
];
    ...
    <div style={{ maxWidth: '100%' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
        <div style={{ padding: '8px', background: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
          <span className="material-symbols-outlined" style={{ fontSize: '24px', color: '#475569' }}>settings</span>
        </div>
        <div>
          <h2 style={{ margin: 0, fontSize: '20px', fontWeight: 800, color: '#111' }}>إعدادات النظام</h2>
          <p style={{ margin: 0, fontSize: '13px', color: '#6b7280' }}>إدارة بيانات المدرسة والمستخدمين والطلاب</p>
        </div>
      </div>
    ...
    <div style={{ maxWidth: '640px', margin: '0 auto' }}>
      ...
      <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #e5e7eb', overflow: 'hidden', marginBottom: '24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 20px', background: '#f9fafb', borderBottom: '1px solid #e5e7eb' }}>
          <span className="material-symbols-outlined" style={{ color: '#6b7280', fontSize: '20px' }}>preview</span>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px', marginTop: '32px', paddingTop: '24px', borderTop: '1px solid #f0f0f0' }}>
            {hasSavedData && (
              <button onClick={() => setEditMode(false)} style={{
                ...
                <span className="material-symbols-outlined" style={{fontSize:16}}>close</span> إلغاء
              </button>
            )}
            <button onClick={handleSave} disabled={saving} style={{
              ...
              <span className="material-symbols-outlined" style={{fontSize:16}}>save</span> {saving ? 'جاري الحفظ...' : 'حفظ واعتماد الكليشة'}
            </button>
          </div>
        </>
      )}
...
const LetterheadPreview: React.FC<{ data: SchoolSettingsData }> = ({ data }) => {
  ...
  return (
    <>
      ...
      <p style={{ fontSize: '18px', fontWeight: 'bold', margin: '0 0 2px', color: '#000' }}>وزارة التعليم</p>
      <p style={{ fontSize: '16px', margin: '2px 0', color: '#333' }}>الشؤون التعليمية</p>
  ...
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '24px', paddingBottom: '16px', borderBottom: '1px solid #f0f0f0' }}>
        <span className="material-symbols-outlined" style={{ color: '#6366f1', fontSize: '24px' }}>account_tree</span>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '32px', paddingTop: '24px', borderTop: '1px solid #f0f0f0' }}>
        <button onClick={handleSave} disabled={saving} style={{
          ...
          <span className="material-symbols-outlined" style={{ fontSize: '18px' }}>save</span> {saving ? 'جاري الحفظ...' : 'حفظ الهيكل'}
        </button>
      </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize: '13px', color: '#dc2626', fontWeight: 700, marginBottom: '20px' }}>
              <span className="material-symbols-outlined" style={{ fontSize: '16px', verticalAlign: 'middle' }}>block</span> هذا الإجراء لا يمكن التراجع عنه!
            </p>
