      ...
      <div style={{ ...styles.body, background: '#f0fdf4' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100%', padding: '32px 16px', textAlign: 'center' }}>
          ...
          <div style={{ marginTop: 20, padding: '12px 14px', background: '#fef3c7', border: '2px solid #fde68a', borderRadius: 12, width: '100%', maxWidth: 480 }}>
            <p style={{ fontSize: 12, fontWeight: 600, color: '#92400e', lineHeight: 1.6, textAlign: 'right' }}><span className="material-symbols-outlined" style={{ fontSize: '16px', verticalAlign: 'middle' }}>info</span> في حال وجود مرفقات، يرجى تسليمها مع الطالب عند حضوره للمدرسة.</p>
          </div>
  ...
  return (
    <div style={styles.body}>
      ...
      <div style={styles.header}>
        <div style={{ maxWidth: 480, margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <span className="material-symbols-outlined" style={{ fontSize: '30px', lineHeight: 1, color: 'white' }}>apartment</span>
            <div>
          ...
          <div style={styles.studentCard}>
            <span style={{ fontSize: 26, lineHeight: 1 }}><span className="material-symbols-outlined" style={{ fontSize: '26px' }}>person</span></span>
            <div style={{ flex: 1 }}>
      ...
      <div style={styles.mainContainer}>
        <div style={{ maxWidth: 480, margin: '0 auto' }}>
          {/* Date bar */}
          <div style={styles.dateBar}><span className="material-symbols-outlined" style={{ fontSize: '16px', verticalAlign: 'middle' }}>calendar_today</span> {pageData.today?.day || ''} - {pageData.today?.date || ''}</div>
          ...
          <div style={styles.formSection}>
            <div style={styles.formTitle}><span className="material-symbols-outlined" style={{ fontSize: '16px', verticalAlign: 'middle' }}>calendar_today</span> تاريخ الغياب</div>
          ...
          {/* Attachments */}
          <div style={styles.formSection}>
            <div style={styles.formTitle}><span className="material-symbols-outlined" style={{ fontSize: '18px', verticalAlign: 'middle' }}>attach_file</span> المرفقات</div>
      ...
      <div style={styles.submitArea}>
        <button onClick={handleSubmit} disabled={submitting || excuseText.trim().length < 5} style={styles.btnSubmit}>
          {submitting ? <><span className="material-symbols-outlined" style={{ fontSize: '16px', verticalAlign: 'middle' }}>hourglass_empty</span> جاري الإرسال...</> : <><span className="material-symbols-outlined" style={{fontSize:16,verticalAlign:'middle'}}>upload</span> إرسال العذر</>}
        </button>
      </div>
