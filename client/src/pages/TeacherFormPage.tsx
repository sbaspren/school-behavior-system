          ...
          <div style={styles.stepBody}>
            ...
            {selectedType === 'absence' && (
              <div style={styles.noAbsenceBtn} onClick={handleConfirmNoAbsence}>
                ...
                <span style={{ fontWeight: 800, color: '#166534', fontSize: 15 }}>لا يوجد غائب <span className="material-symbols-outlined" style={{ fontSize: '16px', verticalAlign: 'middle' }}>check_circle</span></span>
              </div>
            )}
      ...
      <div style={step === 5 ? styles.stepPanelActive : styles.stepPanel}>
          ...
          <div style={{ ...styles.stepBody, display: 'flex', flexDirection: 'column' }}>
            <div style={styles.summaryBox}>
              {noAbsence ? (
                <>
                  <SummaryRow label="الحالة" value={<>لا يوجد غائب <span className="material-symbols-outlined" style={{ fontSize: '16px', verticalAlign: 'middle' }}>check_circle</span></>} valueColor="#22c55e" />
