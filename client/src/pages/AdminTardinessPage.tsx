      ...
      <div style={S.header}>
        <div style={S.hdrRow}>
          <div>
            ...
            <div style={S.hdrSub}><span className="material-symbols-outlined" style={{ fontSize: '18px', verticalAlign: 'middle' }}>person</span> {pageData.staff.name}{pageData.staff.role ? ` — ${pageData.staff.role}` : ''}</div>
          </div>
