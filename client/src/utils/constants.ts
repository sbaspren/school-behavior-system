...
// تصنيف الأدوار حسب النوع
export type RoleCategory = 'data_only' | 'desktop_account' | 'mobile_link' | 'mobile_link_shared';
export const ROLE_CATEGORY: Record<string, RoleCategory> = {
  'مدير المدرسة': 'data_only',
  'وكيل الشؤون التعليمية': 'data_only',
  'وكيل الشؤون المدرسية': 'data_only',
  'وكيل شؤون الطلاب': 'desktop_account',
  'موجه طلابي': 'mobile_link',
  'إداري': 'mobile_link_shared',
  'حارس': 'mobile_link_shared',
};

// هل الدور يدعم حساب دخول (حالياً أو مستقبلاً)
export const ROLE_SUPPORTS_LOGIN: Record<string, 'active' | 'soon' | 'no'> = {
  'مدير المدرسة': 'no',
  'وكيل الشؤون التعليمية': 'no',
  'وكيل الشؤون المدرسية': 'no',
  'وكيل شؤون الطلاب': 'active',
  'موجه طلابي': 'soon',
  'إداري': 'soon',
  'حارس': 'no',
};

// هل الفصل يُحجز لشخص واحد فقط من هذا الدور أم يمكن مشاركته
export const ROLE_EXCLUSIVE_CLASSES: Record<string, boolean> = {
  'وكيل شؤون الطلاب': true,
  'موجه طلابي': true,
  'إداري': false,
  'حارس': false,
};
...
export const ROLE_INTERFACE_DESC: Record<string, string> = {
  'مدير المدرسة': 'بيانات',
  'وكيل شؤون الطلاب': 'حساب',
  'وكيل الشؤون التعليمية': 'بيانات',
  'وكيل الشؤون المدرسية': 'بيانات',
  'موجه طلابي': 'جوال',
  'إداري': 'جوال',
  'حارس': 'جوال',
};
