...
public class SettingsController : ControllerBase
{
    ...
    public async Task<ActionResult<ApiResponse<object>>> GetStructure()
    {
        ...
        // جلب جميع المراحل من قاعدة البيانات (مفعّلة وغير مفعّلة) لعرضها في محرر الهيكل
        var allDbStages = await _configService.GetAllStagesAsync();

        var stagesArray = allDbStages.Select(s => new
        {
